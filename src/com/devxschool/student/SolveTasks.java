...
public class SolveTasks {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter any number I will calculate a multiplication by 9 without multiplying: ");
...
//        Validation.testMultiplicationBy9(number, myResult);
        ...
        double jake = scann.nextDouble();
        System.out.print("Phil's: ");
        double phil = scann.nextDouble();
        System.out.print("Ryan's: ");
        double ryan = scan.nextDouble();
        System.out.print("Tom's: ");
        double tom = scann.nextDouble();
        System.out.print("Bill's: ");
        double bill = scann.nextDouble();
        ...
        ;
        int years = (int) ((min / 525.600) / 1000);
